    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <!-- Shopping Cart -->
                <a href="/show/panier" class="text-gray-300 hover:text-cinema-gold relative group">
                    <div class="flex items-center">
                ...
                <div class="flex items-center space-x-4 ml-6">
                    <a href="/dashboard" class="text-gray-300 hover:text-cinema-gold">Dashboard</a>
            ...
            <div class="md:hidden flex items-center space-x-4">
                ...
                <a href="/show/panier" class="text-gray-300 hover:text-cinema-gold relative">
