...
<body class="bg-cinema-dark text-cinema-light">
    ...
    <main class="flex-1 overflow-auto">
      <div class="p-8">
        <div class="flex justify-between items-center mb-8">
          <h1 class="text-3xl font-bold">Gestion des Genres</h1>
          <a href="/create/genre" class="bg-cinema-gold hover:bg-yellow-500 text-black font-bold py-2 px-4 rounded-lg flex items-center">
          ...
          <div class="bg-[#1a1c1e] rounded-xl p-6">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
              ...
              <div class="flex gap-2">
                <form method="POST" action="/update/{{$genre->id}}/genre">
                  @csrf
  ...
  <div id="deleteModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
    <div class="bg-[#1a1c1e] rounded-xl p-6 max-w-md w-full mx-4">
        ...
        <p class="mb-6">Êtes-vous sûr de vouloir supprimer le genre <span id="genreToDelete" class="text-cinema-gold"></span> ? Cette action est irréversible.</p>
        <div class="flex justify-end gap-3">
            ...
            <!-- Le formulaire de suppression qui utilise l'ID dynamique du genre -->
  ...
  <script>
    function confirmDelete(id, name) {
        document.getElementById("genreToDelete").innerText = name;
        
        const formAction = '/delete/' + id + '/genre'; 
