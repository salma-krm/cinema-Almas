            ...
            <table class="w-full">
              ...
              <tbody class="text-gray-300">
                ...
                <tr class="border-b border-gray-700">
                  ...
                  <td class="py-3">{{ $film->duree }} min</td>
                  <td class="py-3">{{ $film->genre->name ?? 'N/A' }}</td>
                  <td class="py-3">
                    <span class="px-2 py-1 bg-green-900 text-green-200 rounded-full text-xs">
                      En cours
                    </span>
                  </td>
                  ...
                  <td class="py-3">
                    <div class="flex space-x-2">
                      <!-- Modifier -->
                      <a href="" class="p-1 text-blue-400 hover:text-blue-300">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M15.232 5.232l3.536 3.536m0 0L12 15l-4 1 1-4 6.768-6.768z" />
                        </svg>
                      </a>
                  
                      <!-- Supprimer -->
                      <form method="POST" action="" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce film ?');">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="p-1 text-red-400 hover:text-red-300">
                          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
