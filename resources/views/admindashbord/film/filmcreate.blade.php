        ...
        <form id="add-movie-form" method="POST" action="/create/film" enctype="multipart/form-data">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div class="space-y-6">
              ...
              <!-- Budget Input -->
              <div>
                <label for="movie-budget" class="block text-sm font-medium mb-2">price du Film *</label>
              ...
              <div>
                ...
                <input type="text" id="movie-video" name="video" accept="video/*" class="w-full bg-[#131416] border border-gray-700 rounded-lg py-2 px-4 text-white">
              </div>
            </div>
          </div>
