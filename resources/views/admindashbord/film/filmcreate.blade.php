    ...
    <main class="flex-1 overflow-auto md:pt-0 pt-16">
      <div class="p-4 md:p-8">
        <div class="flex justify-between items-center mb-6">
          <h1 class="text-2xl md:text-3xl font-bold">Ajouter un Nouveau Film</h1>
        </div>

        <!-- Add Movie Form -->
        <form id="add-movie-form" method="POST" action="/create/film" enctype="multipart/form-data">
          @csrf
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div class="space-y-6">
              ...
              <div>
                ...
                <input type="text" id="movie-director" name="realisateur" required class="w-full bg-[#131416] border border-gray-700 rounded-lg py-2 px-4 text-white">
              </div>

              <!-- Langue Input -->
              <div>
                <label for="movie-language" class="block text-sm font-medium mb-2">Langue *</label>
                <input type="text" id="movie-language" name="langue" required class="w-full bg-[#131416] border border-gray-700 rounded-lg py-2 px-4 text-white" placeholder="Ex : Français, Anglais...">
              </div>

              <div class="grid grid-cols-2 gap-4">
                <div>
                  <label for="movie-duration" class="block text-sm font-medium mb-2">Durée (minutes) *</label>
                  <input type="number" id="movie-duration" name="duree" required class="w-full bg-[#131416] border border-gray-700 rounded-lg py-2 px-4 text-white">
                </div>
                <div>
                  <label for="movie-release-date" class="block text-sm font-medium mb-2">Date de sortie *</label>
                  <input type="date" id="movie-release-date" name="date_sortie" required class="w-full bg-[#131416] border border-gray-700 rounded-lg py-2 px-4 text-white">
                </div>
              </div>
            ...
            <div class="space-y-6">
              ...
              <!-- Budget Input -->
              <div>
                <label for="movie-budget" class="block text-sm font-medium mb-2">Budget du Film *</label>
                <input type="number" id="movie-budget" name="budget" required class="w-full bg-[#131416] border border-gray-700 rounded-lg py-2 px-4 text-white" placeholder="Ex : 1000000" step="0.01">
              </div>
              ...
              <div>
                ...
                <textarea id="movie-resume" name="resume" rows="4" class="w-full bg-[#131416] border border-gray-700 rounded-lg py-2 px-4 text-white resize-none"></textarea>
              </div>

              <div>
                <label for="movie-video" class="block text-sm font-medium mb-2">Vidéo du Film</label>
                <input type="file" id="movie-video" name="video" accept="video/*" class="w-full bg-[#131416] border border-gray-700 rounded-lg py-2 px-4 text-white">
              </div>
            </div>
          </div>
